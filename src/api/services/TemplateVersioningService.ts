...
export class TemplateVersioningService {
    ...
    public static listTemplateVersions({
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/dashboard/api/v2/templates/{template_id}/versions/',
            path: {
    ...
    public static getTemplateVersion({
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/dashboard/api/v2/templates/{template_id}/versions/{id}/',
            path: {
                'id': id,
                'template_id': templateId,
            },
    ...
    public static copyTemplateFromVersion({
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/dashboard/api/v2/templates/{template_id}/versions/{id}/copy/',
            path: {
                'id': id,
                'template_id': templateId,
            },
    ...
    public static getTemplateMinorVersions({
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/dashboard/api/v2/templates/{template_id}/versions/{id}/minor_versions/',
            path: {
                'id': id,
                'template_id': templateId,
            },
    ...
    public static updateTemplateVersionName({
        ...
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/dashboard/api/v2/templates/{template_id}/versions/{id}/rename/',
            path: {
                'id': id,
                'template_id': templateId,
            },
    ...
    public static setTemplateVersionLive({
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/dashboard/api/v2/templates/{template_id}/versions/{id}/set_as_live_version/',
            path: {
                'id': id,
                'template_id': templateId,
            },
    ...
    public static toggleTemplateVersionStarred({
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/dashboard/api/v2/templates/{template_id}/versions/{id}/toggle_starred/',
            path: {
                'id': id,
                'template_id': templateId,
            },
