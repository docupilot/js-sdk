...
import type { CustomerChatThreads } from '../models/CustomerChatThreads';
...
export class AiChatService {
    ...
    public static listAllChatThreads({
         ...
         */
        search?: string,
    }): CancelablePromise<Array<CustomerChatThreads>> {
    ...
    public static aiChatThreadsRetrieve({
        ...
        threadId: string,
    }): CancelablePromise<CustomerChatThreads> {
        return __request(OpenAPI, {
            method: 'GET',
