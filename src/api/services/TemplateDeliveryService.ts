...
export class TemplateDeliveryService {
    ...
    public static listTemplateDeliveries({
         ...
         */
        ordering?: string,
        type?: 'aws_s3' | 'azure_blob_storage' | 'box_drive' | 'docu_sign' | 'dropbox' | 'email' | 'eversign' | 'google_cloud_storage' | 'google_drive' | 'hellosign' | 'one_drive' | 'podio' | 'sftp' | 'sign_now' | 'signable' | 'signature' | 'webhook' | 'yousign' | 'zoho_crm',
