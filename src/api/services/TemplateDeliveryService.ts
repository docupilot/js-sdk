...
export class TemplateDeliveryService {
    ...
    public static listTemplateDeliveries({
         ...
         */
        ordering?: string,
        type?: 'aws_s3' | 'azure_blob_storage' | 'docu_sign' | 'dropbox' | 'email' | 'eversign' | 'google_drive' | 'hellosign' | 'one_drive' | 'podio' | 'sftp' | 'sign_now' | 'signable' | 'webhook' | 'yousign' | 'zoho_crm',
