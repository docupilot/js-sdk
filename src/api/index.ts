...
export type { GenerateDocumentFromHubspot } from './models/GenerateDocumentFromHubspot';
...
export type { TemplateHubspotModuleMapping } from './models/TemplateHubspotModuleMapping';
