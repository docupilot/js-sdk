...
import type { GoogleCloudStorageDelivery } from './GoogleCloudStorageDelivery';
...
export type PolymorphicDelivery = (EmailDelivery | WebhookDelivery | SignatureDelivery | DropboxDelivery | OneDriveDelivery | SignNowDelivery | GoogleDriveDelivery | GoogleCloudStorageDelivery | S3Delivery | HelloSignDelivery | DocuSignDelivery | EversignDelivery | SignableDelivery | YouSignDelivery | SftpDelivery | AzureBlobStorageDelivery | BoxDriveDelivery);
